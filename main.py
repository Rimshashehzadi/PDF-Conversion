...
API_KEY = "rimshashehzadi79@gmail.com_x7rDKy1T0CKTOLpjHc1NLEiooTYajjIP38ypWExxOR4fcYahURMCTXCiIFRdJTTT"
...
def convertPdfToJson(uploadedFileUrl, destinationFile):
    ...
    # See documentation: https://developer.pdf.co/api/pdf-to-json/index.html
    parameters = {}
